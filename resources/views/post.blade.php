                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <div class="blog-image"><img src="{{ Storage::disk('public')->url('post/'.$randopost->image) }}" alt="$post->title"></div>
                                        ...
                                        <li>
                                            ...
                                            @guest
                                                <a href="javascript:void(0);" onclick="toastr.info('To add favorite list. You need to login first.','Info',{
                                                    closeButton: true,
                                                    progressBar: true,
                                                })"><i class="ion-heart"></i>{{ $randopost->favorite_to_users->count() }}</a>
                                            ...
                                            @else
                                                <a href="javascript:void(0);" onclick="document.getElementById('favorite-form-{{ $randopost->id }}').submit();"
                                                   class="{{ !Auth::user()->favorite_posts->where('pivot.post_id',$randopost->id)->count()  == 0 ? 'favorite_posts' : ''}}"><i class="ion-heart"></i>{{ $post->favorite_to_users->count() }}</a>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="comment-form">
                        ...
                        @guest
                            <p>
                                For a new comment.You need to login first
...
{{--                        <div class="comment">--}}
{{--                            <h5 class="reply-for">Reply for <a class="name" href="#"><b>{{ $post->user->name }}</b></a></h5>--}}
